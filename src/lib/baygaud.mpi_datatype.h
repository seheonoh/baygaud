...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MPI_Datatype type[324] = {/* Process + einasto output file + Parameters for multinest */
                        ...
                        MPI_INT, // 303:int nax3

                        MPI_INT, // 304:int sorting_order
                        MPI_INT, // 305:int N_channels
                        MPI_INT, // 306:int N_channel_outliers
                        MPI_INT, // 307:int N_channel_outliers
                        MPI_DOUBLE, // 308:double velocity_profile_norm
                        MPI_DOUBLE, // 309:double velocity_profile
                        MPI_DOUBLE, // 310:double velocity_profile_e

                        MPI_FLOAT, // 311:double velocity_offset
                        MPI_FLOAT, // 312:double Velocity_Seperation
                        MPI_FLOAT, // 313:double Reference_Velocity
                        MPI_DOUBLE, // 314:double vel_profile_res_RBM
                        MPI_DOUBLE, // 315:double vel_profile_res_SIGMA
                        MPI_INT, // 316:int effective_channel_start
                        MPI_INT, // 317:int effective_channel_end
                        MPI_DOUBLE, // 318:double unit_channel_width
                        MPI_INT, // 319:int xlower
                        MPI_INT, // 320:int xupper
                        MPI_INT, // 321:int ylower
                        MPI_INT, // 322:int yupper
                        MPI_INT, // 323:int _i_
                        MPI_INT // 324:int _j_
                        };

int blocklen[324] = {// Process + einasto output file + Parameters for multinest
                    ...
                    1, // 302:int _nfilter
                    1, // 303:int nax3
					1, 1, 1, 1, // 304:int sorting_order , 305:int N_channels , 306:int N_channel_outliers 307:int outliers_channelNumber
					1, 1, 1, // 308:double velocity_profile_norm, 309:double velocity_profile, 310:double velocity_profile_e
					1, 1, 1, 1, 1, // 311:double velocity_offset, 312:double Velocity_Seperation, 313:double Reference_Velocity, 314:double vel_profile_res_RBM, 315:double vel_profile_res_SIGMA
					1, 1, // 316:int effective_channel_start, 317:int effective_channel_end
					1, // 318:double unit_channel_width
					1, 1, 1, 1, // 319:int xlower, 320:int xupper, 321:int ylower, 322:int yupper
					1, 1 // 323:int _i_, 324:int _j_
                };
