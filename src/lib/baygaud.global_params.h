...
typedef struct {
    ...
    char fitsfile_bvf[15][8];
    char fitsfile_bvf_e[15][8];
...
extern velocity_field BVF[120]; // array for bvf program; bulk velocity field : global
extern velocity_field BVF_e[120]; // array for bvf program; bulk velocity field : global

extern velocity_field BVF_analysis[120]; // array for bvf program; bulk velocity field : global
extern velocity_field BVF_analysis_e[120]; // array for bvf program; bulk velocity field : global

// global 3d arrays : accessible to log_likelihood function in multinest
extern _cube raw_cube[1]; // array for 3D cube : global
extern _cube raw_cube_mpi[1]; // array for 3D cube : global
extern _gfit_params gfit_params_mpi[1]; // array for 4D gfit params : global
extern _gfit_params gfit_params_e_mpi[1]; // array for 4D gfit params : global
